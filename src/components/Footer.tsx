...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0A0A0A] py-12 relative">
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-neon-purple/30 to-transparent"></div>
      
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10">
            <a href="#home" className="text-2xl font-bold text-gradient mb-6 md:mb-0">PortfolioX</a>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <a href="#portfolio" className="text-white/70 hover:text-white transition-colors duration-300">Portfolio</a>
              <a href="#skills" className="text-white/70 hover:text-white transition-colors duration-300">Skills</a>
          ...
          <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/50 text-sm mb-4 md:mb-0">
              &copy; {currentYear} PortfolioX. All rights reserved.
            </p>
